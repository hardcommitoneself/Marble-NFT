...
export const CreateNFTBulk = () => {
  ...
  const createNFTs = async(e) => {
    ...
    const cwCollectionContract = Collection(collection.collection_address).useTx(signingClient)
    ...
    let result = await cwCollectionContract.batchMint(address, owners, cids, extension)
